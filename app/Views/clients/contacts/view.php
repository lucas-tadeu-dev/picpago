...
<div id="page-content" class="clearfix">
    ...
    <ul id="client-contact-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs scrollable-tabs b-b rounded-0" role="tablist">
        ...
        <!-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ----------------------------------------------------------------------------------CUSTOM SECRET KEY CO-NFIG--------------------------------------------------------------------------------------------------------
        ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------>
        
        
        -
           <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("clients/contact_secretkey/" . $user_info->id); ?>" data-bs-target="#contact_secretkey"> <?php echo 'Segurança'; ?></a></li>
    ...
    <div class="tab-content">
        ...
        <div role="tabpanel" class="tab-pane fade" id="contact_secretkey"></div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        setTimeout(function () {
            ...
            else if (tab === "contact_secretkey") {
             $("[data-bs-target='#contact_secretkey']").trigger("click");
            }
            else if (tab === "company") {
