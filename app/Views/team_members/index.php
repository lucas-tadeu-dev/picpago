...
<script type="text/javascript">
   $(document).ready(function () {
    ...
    var visibleTransfer = false; // Defina a variável para controlar a exibição da coluna "Transferir" (inverte a lógica)
    ...
    $("#team_member-table").appTable({
        ...
        columns: [
            ...
            {visible: visibleTransfer, title: '<?php echo app_lang("transfer") ?>', "class": "w15p column-transfer"},
