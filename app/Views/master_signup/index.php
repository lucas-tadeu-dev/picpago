                ...
                <div class="form-signin">
                    <div class="card bg-white clearfix">
                        <div class="card-header text-center">
                            <h2 class="form-signin-heading"><?php echo 'Plano Revedendor Master'; ?></h2>
                            <p><?php echo $signup_message; ?></p>
                        </div>
                        <div class="card-body p30 rounded-bottom">
                            <?php
                            $action_url = ($signup_type == "send_verify_email") ? "signup/send_verification_mail" : "master_signup/create_account";
                            ...
                            <?php } else { ?>
                                <div class="form-group">
                                    <label for="name" class="col-md-12"><?php echo 'Nome'; ?></label>
                                    <div class="col-md-12">
                                        <?php
                                        echo form_input(array(
                                            "id" => "first_name",
                                ...
                                <div class="form-group">
                                    <label for="last_name" class="col-md-12"><?php echo 'Sobrenome'; ?></label>
                                    <div class="col-md-12">
                                        <?php
                                        echo form_input(array(
                                            "id" => "last_name",
