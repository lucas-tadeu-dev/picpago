...
<head>
  ...
  <meta charset="UTF-8" />
  <style>
    .sidenav>li.nav-header>a:is(:hover, :hover, :touch) {
      color: black;
    }
  ...
  <script src="<?php echo base_url("assets/js/swagger/swagger1.js"); ?>"></script>
  ...
  <script src="<?php echo base_url("assets/js/swagger/swagger2.js"); ?>"></script>
...
<body>
  ...
  <script>
    ...
    defs["Mercadopago"] = {
      "type": "object",
      "required": ["PaymentForm", "email", "id", "name"],
      "properties": {
        "id": {
          "type": "string",
          "description": "ID da compra realizada"
        },
        "email": {
          "type": "string",
        ...
        "PaymentForm": {
          "type": "string",
          "description": "Use 'pix' para Pagamento com Pix"
        },
        "name": {
          "type": "string",
    ...
    defs["MercadopagoInput"] = {
      "type": "object",
      "required": ["description", "payer_email", "payment_method_id", "transaction_amount"],
      "properties": {
        "transaction_amount": {
          "type": "integer",
        ...
        "picpago_email": {
          "type": "string",
          "description": "Email da picpago, destinátário para o pagamento. \"**Deve ter conta na PicPago**\""
        }
      }
    };
    defs["MercadopagoResponse"] = {
      "type": "object",
      "properties": {
        "status": {
          "type": "string",
          "description": "Status da compra realizada"
        },
        "transactionId": {
          "type": "string",
          "description": "ID da compra realizada"
        ...
        "status_detail": {
          "type": "string",
          "description": "Detalhes do status da compra"
        }
      }
    };
    defs["pagarme"] = {
    ...
    defs["pagarmeInput"] = {
      ...
      "properties": {
        "customer": {
          "$ref": "#/definitions/pagarmeInput_customer"
        },
        "items": {
          "$ref": "#/definitions/pagarmeInput_items"
        },
        "payments": {
          "$ref": "#/definitions/pagarmeInput_payments"
        },
        "payment_method": {
          "type": "string",
          "description": "Método de pagamento deve ser 'pix' ou 'boleto' ou 'cartão de crédito'"
        },
        "order_id": {
          "type": "integer",
          "description": "Número do pedido para controle interno do lojista"
        },
        "payer_email": {
          "type": "string",
          "description": "Email do comprador"
        ...
        "quantity": {
          "type": "string",
          "description": "Quantidade de items"
        },
        "item_id": {
          "type": "string",
          "description": "Id do item para controle do lojista"
        },
        "price_cents": {
          "type": "string",
          "description": "Preço em centavos da transação"
        },
        "picpago_email": {
          "type": "string",
          "description": "Email da picpago, destinátário para o pagamento. \"**Deve ter conta na PicPago**\""
    ...
    defs["pagarmeInput_customer"] = {
      ...
      "properties": {
        ...
        "type": {
          "type": "string",
          "description": "individual (pessoa física) ou company (pessoa jurídica)."
        },
        "email": {
          "type": "string",
    ...
    defs["pagarmeInput_items"] = {
      ...
      "properties": {
        ...
        "code": {
          "type": "string",
          "description": "Código para controle interno do lojista"
        }
      }
    };
    defs["pagarmeInput_payments"] = {
      "type": "object",
      "properties": {
        "payment_method": {
          "type": "string",
          "description": "Meio de pagamento. Valores possíveis credit_card, boleto, voucher, bank_transfer, safety_pay, checkout, cash, pix."
        },
        "amount": {
          "type": "integer",
          "description": "Valor da transação"
        ...
        "pix": {
          "$ref": "#/definitions/pagarmeInput_payments_pix"
        },
        "boleto": {
          "$ref": "#/definitions/pagarmeInput_payments_boleto"
        },
        "credit_card": {
          "$ref": "#/definitions/pagarmeInput_payments_credit_card"
        }
      }
    };
    defs["pagarmeInput_payments_boleto"] = {
      "type": "object",
      "properties": {
        "bank": {
          "type": "integer",
          "description": "Código do banco. 001 (Banco do Brasil); 033 (Santander); 237 (Bradesco); 341 (Itau); 745 (Citibank) e 104 (Caixa Econômica Federal)."
        },
        "due_at": {
          "type": "integer",
          "description": "Data de vencimento"
        ...
        "type": {
          "type": "string",
          "description": "Tipo de espécie do boleto.DM (Duplicata Mercantil) e BDP (Boleto de proposta)"
        }
      },
      "description": "Dados sobre o pagamento com boleto (obrigatório caso o payment_method seja boleto)"
    };
    defs["pagarmeInput_payments_credit_card"] = {
      "type": "object",
      "properties": {
        "operation_type": {
          "type": "string",
          "description": "Indica se a transação deve ser capturada \"auth_and_capture\", autorizada \"auth_only\", ou pré autorizada \"pre_auth\""
        },
        "installments": {
          "type": "integer",
        ...
        "statement_descriptor": {
          "type": "string",
          "description": "Texto exibido na fatura do cartão. Max 22 caracteres para clientes Gateway; 13 para clientes PSP"
        },
        "card": {
          "$ref": "#/definitions/pagarmeInput_payments_credit_card_card"
        }
      },
      "description": "Dados sobre o pagamento com boleto (obrigatório caso o payment_method seja credit_card)"
    };
    defs["pagarmeInput_payments_credit_card_card"] = {
      "type": "object",
      "properties": {
        "number": {
          "type": "string",
        ...
        "holder_name": {
          "type": "string",
          "description": "Nome do propietário do Cartão"
        },
        "exp_month": {
          "type": "string",
    ...
    defs["pagarmeInput_payments_pix"] = {
      "type": "object",
      "properties": {
        "expires_in": {
          "type": "integer",
          "description": "data que expira"
        },
      ...
      "description": "Dados sobre o pagamento com pix (obrigatório caso o payment_method seja pix)"
    };
    defs["pagarmeResponse"] = {
      "type": "object",
      "properties": {
        "id": {
          "type": "string",
        ...
        "last_transaction": {
          "$ref": "#/definitions/pagarmeResponse_last_transaction"
        },
        "due_date": {
          "type": "string",
          "description": "Data de vencimento"
        ...
        "qrcode_base64": {
          "type": "string",
          "description": "Base64 do pix"
        },
        "pix_url": {
          "type": "string",
          "description": "URL do pix"
        },
        "emv": {
          "type": "string",
          "description": "emv do pix"
        },
        "bacen_url": {
          "type": "string",
          "description": "bacen_url do pix"
        },
        "url_slip": {
          "type": "string",
          "description": "url_slip do Boleto"
        },
        "digitable_line": {
          "type": "string",
          "description": "digitable_line do Boleto"
        }
      }
    };
    defs["pagarmeResponse_last_transaction"] = {
      "type": "object",
      "properties": {
        "transaction_type": {
          "type": "object",
          "description": "Tipo da transação(pix, boleto, cartão de crédito)",
          "properties": {}
        },
        "status": {
          "type": "object",
    ...
    defs["paghiperInput"] = {
      "type": "object",
      "required": ["days_due_date", "description", "item_id", "order_id", "payer_email", "payer_name", "payment_method", "picpago_email", "price_cents", "quantity"],
      "properties": {
        "payment_method": {
          "type": "string",
          "description": "Método de pagamento deve ser 'pix' ou 'boleto'"
        },
        "order_id": {
          "type": "integer",
          "description": "Número do pedido para controle interno do lojista"
    ...
    defs["paghiperResponse"] = {
      ...
      "properties": {
        ...
        "response_message": {
          "type": "string",
          "description": "Resposta Pagamento"
        },
        "created_date": {
          "type": "string",
        ...
        "value_cents": {
          "type": "string",
          "description": "Valor em centavos da compra"
        },
        "order_id": {
          "type": "string",
          "description": "Data da Ordem"
    ...
    defs["StripeInput"] = {
      "type": "object",
      "required": ["amount", "description", "picpago_email", "source"],
      "properties": {
        "amount": {
          "type": "integer",
          "description": "Valor da transação"
        ...
        "source": {
          "type": "string",
          "description": "Chave Publicável da Stripe enviada através do checkout Stripe"
        },
        "picpago_email": {
          "type": "string",
          "description": "Email da picpago, destinátário para o pagamento. \"**Deve ter conta na PicPago**\""
    ...
    defs["StripeResponse"] = {
      ...
      "properties": {
        ...
        "description": {
          "type": "string",
          "description": "Descrição da compra realizada"
        }
      }
    };
  </script>
  ...
  <div class="container-fluid">
    <div class="row-fluid">
      <div id="sidenav" class="span2">
        <nav id="scrollingNav">
          <ul class="sidenav nav nav-list">
            ...
            <li class="nav-header" data-group="MercadoPago"><a href="#api-MercadoPago">API Methods - MercadoPago</a></li>
            <li data-group="MercadoPago" data-name="createPayment" class="">
              <a href="#api-MercadoPago-createPayment">createPayment</a>
            </li>
            <li data-group="MercadoPago" data-name="getPayment" class="">
              <a href="#api-MercadoPago-getPayment">getPayment</a>
            </li>
            <li class="nav-header" data-group="PagHiper"><a href="#api-PagHiper">API Methods - PagHiper</a></li>
            <li data-group="PagHiper" data-name="createPaghiperPayment" class="">
              <a href="#api-PagHiper-createPaghiperPayment">createPaghiperPayment</a>
            </li>
            <li class="nav-header" data-group="PagarMe"><a href="#api-PagarMe">API Methods - PagarMe</a></li>
            <li data-group="PagarMe" data-name="createPagarmePayment" class="">
              <a href="#api-PagarMe-createPagarmePayment">createPagarmePayment</a>
            </li>
            <li class="nav-header" data-group="Stripe"><a href="#api-Stripe">API Methods - Stripe</a></li>
            <li data-group="Stripe" data-name="createStripePayment" class="">
              <a href="#api-Stripe-createStripePayment">createStripePayment</a>
            </li>
            <li data-group="Stripe" data-name="stripe" class="">
              <a href="#api-Stripe-stripe">stripe</a>
            </li>
          </ul>
        </nav>
      </div>
      <div id="content">
        <div id="project">
          <div class="pull-left social-ul social-logo">
            <a class="logo-white" href=".com.br/"><span>PIC</span>PAGO</a>
          </div>
        ...
        <div id="header">
          <div id="api-_">
            ...
            <p>Consuma nossa API e faça pagamentos por PIX, BOLETOS ou CARTÃO DE CRÉDITO. Após se cadastrar em nosso sistema e obter um plano, além de gerenciar seus métodos de pagamento e integrar de forma facilitada dentro da PicPago, agora você também pode integrar em seu site fazer, consultar pagamentos usando nosso sistema!</p>
            <div class="app-desc">Version: 1.0.0</div>
            <hr>
            <div>API do Picpago - Gerenciador de Pagamentos</div>
          </div>
        </div>
        <div id="sections">
          <section id="api-MercadoPago">
            <h1>MercadoPago</h1>
            <div id="api-MercadoPago-createPayment">
              <article id="api-MercadoPago-createPayment-0" data-group="User" data-name="createPayment" data-version="0">
                <div class="pull-left">
                  <h1>createPayment</h1>
                  <p></p>
                </div>
                ...
                <div class="clearfix"></div>
                <p></p>
                <p class="marked">Criar Pagamentos com o **Mercado Pago**</p>
                <p></p>
                <br />
                <pre class="prettyprint language-html prettyprinted" data-type="post"><code><span class="pln">/mercadopago</span></code></pre>
                <p>
                <h3>Usage and SDK Samples</h3>
                </p>
                <ul class="nav nav-tabs nav-tabs-examples">
                  <li class="active"><a href="#examples-MercadoPago-createPayment-0-curl">Curl</a></li>
                  <li class=""><a href="#examples-MercadoPago-createPayment-0-java">Java</a></li>
                  <li class=""><a href="#examples-MercadoPago-createPayment-0-android">Android</a></li>
                  <!--<li class=""><a href="#examples-MercadoPago-createPayment-0-groovy">Groovy</a></li>-->
                  <li class=""><a href="#examples-MercadoPago-createPayment-0-objc">Obj-C</a></li>
                  <li class=""><a href="#examples-MercadoPago-createPayment-0-javascript">JavaScript</a></li>
                  <!--<li class=""><a href="#examples-MercadoPago-createPayment-0-angular">Angular</a></li>-->
                  <li class=""><a href="#examples-MercadoPago-createPayment-0-csharp">C#</a></li>
                  <li class=""><a href="#examples-MercadoPago-createPayment-0-php">PHP</a></li>
                  <li class=""><a href="#examples-MercadoPago-createPayment-0-perl">Perl</a></li>
                  <li class=""><a href="#examples-MercadoPago-createPayment-0-python">Python</a></li>
                </ul>

                <div class="tab-content">
                  <div class="tab-pane active" id="examples-MercadoPago-createPayment-0-curl">
                    <pre class="prettyprint"><code class="language-bsh">curl -X POST "https://picpago.com.br/index.php/api/"</code></pre>
                  </div>
                  <div class="tab-pane" id="examples-MercadoPago-createPayment-0-java">
                    <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.MercadoPagoApi;

import java.io.File;
import java.util.*;

public class MercadoPagoApiExample {

    public static void main(String[] args) {
        
        MercadoPagoApi apiInstance = new MercadoPagoApi();
        array[MercadopagoInput] corpo = ; // array[MercadopagoInput] | Descrição do corpo da solicitação
        try {
            array[MercadopagoResponse] result = apiInstance.createPayment(corpo);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling MercadoPagoApi#createPayment");
            e.printStackTrace();
        }
    }
}</code></pre>
                  ...
                  <div class="tab-pane" id="examples-MercadoPago-createPayment-0-android">
                    <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.MercadoPagoApi;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            e.printStackTrace();
                  ...
                  <!--
  <div class="tab-pane" id="examples-MercadoPago-createPayment-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                  <div class="tab-pane" id="examples-MercadoPago-createPayment-0-objc">
                    <pre class="prettyprint"><code class="language-cpp">array[MercadopagoInput] *corpo = ; // Descrição do corpo da solicitação

MercadoPagoApi *apiInstance = [[MercadoPagoApi alloc] init];

[apiInstance createPaymentWith:corpo
              completionHandler: ^(array[MercadopagoResponse] output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            }
                            if (error) {
                  ...
                  <div class="tab-pane" id="examples-MercadoPago-createPayment-0-javascript">
                    <pre class="prettyprint"><code class="language-js">var PicPago = require('pic_pago');

var api = new PicPago.MercadoPagoApi()

var corpo = ; // {array[MercadopagoInput]} Descrição do corpo da solicitação
...
api.createPayment(corpo, callback);
</code></pre>
                  </div>

                  <!--<div class="tab-pane" id="examples-MercadoPago-createPayment-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                  <div class="tab-pane" id="examples-MercadoPago-createPayment-0-csharp">
...
namespace Example
{
    public class createPaymentExample
    {
        public void main()
        {
            ...
            var apiInstance = new MercadoPagoApi();
            var corpo = new array[MercadopagoInput](); // array[MercadopagoInput] | Descrição do corpo da solicitação
            ...
            {
                Debug.Print("Exception when calling MercadoPagoApi.createPayment: " + e.Message );
            }
        }
    }
}
                  ...
                  <div class="tab-pane" id="examples-MercadoPago-createPayment-0-php">
                    <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');

$api_instance = new Swagger\Client\Api\MercadoPagoApi();
$corpo = ; // array[MercadopagoInput] | Descrição do corpo da solicitação

try {
    $result = $api_instance->createPayment($corpo);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MercadoPagoApi->createPayment: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                  </div>

                  <div class="tab-pane" id="examples-MercadoPago-createPayment-0-perl">
                    <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::MercadoPagoApi;

my $api_instance = WWW::SwaggerClient::MercadoPagoApi->new();
my $corpo = [WWW::SwaggerClient::Object::array[MercadopagoInput]->new()]; # array[MercadopagoInput] | Descrição do corpo da solicitação

eval { 
    my $result = $api_instance->createPayment(corpo => $corpo);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling MercadoPagoApi->createPayment: $@\n";
}</code></pre>
                  </div>

                  <div class="tab-pane" id="examples-MercadoPago-createPayment-0-python">
...
api_instance = swagger_client.MercadoPagoApi()
corpo =  # array[MercadopagoInput] | Descrição do corpo da solicitação

try: 
    api_response = api_instance.create_payment(corpo)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling MercadoPagoApi->createPayment: %s\n" % e)</code></pre>
                  </div>
                </div>
                ...
                <table id="methodsubtable">
                  ...
                  <tr>
                    <td style="width:150px;">corpo <span style="color:red;">*</span></td>
                    <td>
                        ...
                        $(document).ready(function() {
                          var schemaWrapper = {
                            ...
                            "schema": {
                              "type": "array",
                              "items": {
                                "$ref": "#/definitions/MercadopagoInput"
                              }
                            }
                          };
                          ...
                          var result = $('#d2e199_createPayment_corpo');
                          result.empty();
                          result.append(view.render());
                        });
                      </script>
                      <div id="d2e199_createPayment_corpo"></div>
                    </td>
                  </tr>
                ...
                <h2>Responses</h2>
                <h3> Status: 201 - retorna informações do pagamento Mercado Pago </h3>

                <ul class="nav nav-tabs nav-tabs-examples">
                  <li class="active">
                    <a data-toggle="tab" href="#responses-createPayment-201-schema">Schema</a>
                  </li>

                </ul>

                <div class="tab-content" style='margin-bottom: 10px;'>
                  <div class="tab-pane active" id="responses-createPayment-201-schema">
                    <div id='responses-createPayment-201-schema-201' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                      <script>
                        $(document).ready(function() {
                          var schemaWrapper = {
                            "description": "retorna informações do pagamento Mercado Pago",
                            "schema": {
                              "type": "array",
                              "items": {
                                "$ref": "#/definitions/MercadopagoResponse"
                              }
                            }
                          };
                          var schema = schemaWrapper.schema;
                          ...
                          $('#responses-createPayment-201-schema-data').val(stringify(schema));
                          var result = $('#responses-createPayment-201-schema-201');
                          result.empty();
                          result.append(view.render());
                        });
                      </script>
                    </div>
                    <input id='responses-createPayment-201-schema-data' type='hidden' value=''></input>
                  </div>
                </div>

                <h3> Status: default - Erro Inesperado </h3>

                <ul class="nav nav-tabs nav-tabs-examples">
                  <li class="active">
                    <a data-toggle="tab" href="#responses-createPayment-default-schema">Schema</a>
                  </li>

                </ul>

                <div class="tab-content" style='margin-bottom: 10px;'>
                  <div class="tab-pane active" id="responses-createPayment-default-schema">
                    <div id='responses-createPayment-default-schema-default' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                      <script>
                        $(document).ready(function() {
                          var schemaWrapper = {
                          ...
                          //console.log(JSON.stringify(schema));
                          var view = new JSONSchemaView(schema, 3);
                          $('#responses-createPayment-default-schema-data').val(stringify(schema));
                          var result = $('#responses-createPayment-default-schema-default');
                          result.empty();
                          result.append(view.render());
                        });
                      </script>
                    </div>
                    <input id='responses-createPayment-default-schema-data' type='hidden' value=''></input>
                  </div>
                </div>
            ...
            <hr>
            <div id="api-MercadoPago-getPayment">
              <article id="api-MercadoPago-getPayment-0" data-group="User" data-name="getPayment" data-version="0">
                <div class="pull-left">
                  <h1>getPayment</h1>
                  <p></p>
                </div>
                ...
                <div class="clearfix"></div>
                <p></p>
                <p class="marked">Este retorna informações do pagamento Mercado Pago, **necessário ID da compra**</p>
                <p></p>
                <br />
                <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/mercadopago</span></code></pre>
                <p>
                <h3>Usage and SDK Samples</h3>
                </p>
                <ul class="nav nav-tabs nav-tabs-examples">
                  <li class="active"><a href="#examples-MercadoPago-getPayment-0-curl">Curl</a></li>
                  <li class=""><a href="#examples-MercadoPago-getPayment-0-java">Java</a></li>
                  <li class=""><a href="#examples-MercadoPago-getPayment-0-android">Android</a></li>
                  <!--<li class=""><a href="#examples-MercadoPago-getPayment-0-groovy">Groovy</a></li>-->
                  <li class=""><a href="#examples-MercadoPago-getPayment-0-objc">Obj-C</a></li>
                  <li class=""><a href="#examples-MercadoPago-getPayment-0-javascript">JavaScript</a></li>
                  <!--<li class=""><a href="#examples-MercadoPago-getPayment-0-angular">Angular</a></li>-->
                  <li class=""><a href="#examples-MercadoPago-getPayment-0-csharp">C#</a></li>
                  <li class=""><a href="#examples-MercadoPago-getPayment-0-php">PHP</a></li>
                  <li class=""><a href="#examples-MercadoPago-getPayment-0-perl">Perl</a></li>
                  <li class=""><a href="#examples-MercadoPago-getPayment-0-python">Python</a></li>
                </ul>

                <div class="tab-content">
                  <div class="tab-pane active" id="examples-MercadoPago-getPayment-0-curl">
                    <pre class="prettyprint"><code class="language-bsh">curl -X GET "https://picpago.com.br/index.php/api/"</code></pre>
                  </div>
                  <div class="tab-pane" id="examples-MercadoPago-getPayment-0-java">
                    <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.MercadoPagoApi;
...
public class MercadoPagoApiExample {
    ...
    public static void main(String[] args) {
        ...
        MercadoPagoApi apiInstance = new MercadoPagoApi();
        try {
            array[Mercadopago] result = apiInstance.getPayment();
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling MercadoPagoApi#getPayment");
            e.printStackTrace();
        }
    }
}</code></pre>
                  ...
                  <div class="tab-pane" id="examples-MercadoPago-getPayment-0-android">
                    <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.MercadoPagoApi;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            e.printStackTrace();
                  ...
                  <!--
  <div class="tab-pane" id="examples-MercadoPago-getPayment-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                  <div class="tab-pane" id="examples-MercadoPago-getPayment-0-objc">
                    <pre class="prettyprint"><code class="language-cpp">
MercadoPagoApi *apiInstance = [[MercadoPagoApi alloc] init];

[apiInstance getPaymentWithCompletionHandler: 
              ^(array[Mercadopago] output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            }
                            if (error) {
                  ...
                  <div class="tab-pane" id="examples-MercadoPago-getPayment-0-javascript">
                    <pre class="prettyprint"><code class="language-js">var PicPago = require('pic_pago');
...
api.getPayment(callback);
</code></pre>
                  </div>

                  <!--<div class="tab-pane" id="examples-MercadoPago-getPayment-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                  <div class="tab-pane" id="examples-MercadoPago-getPayment-0-csharp">
                    <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class getPaymentExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling MercadoPagoApi.getPayment: " + e.Message );
            }
        }
    }
}
                  ...
                  <div class="tab-pane" id="examples-MercadoPago-getPayment-0-php">
                    <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
try {
    $result = $api_instance->getPayment();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MercadoPagoApi->getPayment: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                  </div>

                  <div class="tab-pane" id="examples-MercadoPago-getPayment-0-perl">
                    <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::MercadoPagoApi;
...
eval { 
    my $result = $api_instance->getPayment();
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling MercadoPagoApi->getPayment: $@\n";
}</code></pre>
                  </div>

                  <div class="tab-pane" id="examples-MercadoPago-getPayment-0-python">
                    <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    ...
    print("Exception when calling MercadoPagoApi->getPayment: %s\n" % e)</code></pre>
                  </div>
                </div>
                ...
                <h2>Responses</h2>
                <h3> Status: 200 - retorna informações do pagamento Mercado Pago </h3>

                <ul class="nav nav-tabs nav-tabs-examples">
                  <li class="active">
                    <a data-toggle="tab" href="#responses-getPayment-200-schema">Schema</a>
                  </li>

                </ul>

                <div class="tab-content" style='margin-bottom: 10px;'>
                  <div class="tab-pane active" id="responses-getPayment-200-schema">
                    <div id='responses-getPayment-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                      <script>
                        $(document).ready(function() {
                          var schemaWrapper = {
                            "description": "retorna informações do pagamento Mercado Pago",
                          ...
                          //console.log(JSON.stringify(schema));
                          var view = new JSONSchemaView(schema, 3);
                          $('#responses-getPayment-200-schema-data').val(stringify(schema));
                          var result = $('#responses-getPayment-200-schema-200');
                          result.empty();
                          result.append(view.render());
                        });
                      </script>
                    </div>
                    <input id='responses-getPayment-200-schema-data' type='hidden' value=''></input>
                  </div>
                </div>
                ...
                <ul class="nav nav-tabs nav-tabs-examples">
                  <li class="active">
                    <a data-toggle="tab" href="#responses-getPayment-default-schema">Schema</a>
                  </li>

                </ul>

                <div class="tab-content" style='margin-bottom: 10px;'>
                  <div class="tab-pane active" id="responses-getPayment-default-schema">
                    <div id='responses-getPayment-default-schema-default' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                      <script>
                        $(document).ready(function() {
                          var schemaWrapper = {
                            "description": "Erro Inesperado",
                          ...
                          //console.log(JSON.stringify(schema));
                          var view = new JSONSchemaView(schema, 3);
                          $('#responses-getPayment-default-schema-data').val(stringify(schema));
                          var result = $('#responses-getPayment-default-schema-default');
                          result.empty();
                          result.append(view.render());
                        });
                      </script>
                    </div>
                    <input id='responses-getPayment-default-schema-data' type='hidden' value=''></input>
                  </div>
                </div>
          ...
          <section id="api-PagHiper">
            <h1>PagHiper</h1>
            <div id="api-PagHiper-createPaghiperPayment">
              <article id="api-PagHiper-createPaghiperPayment-0" data-group="User" data-name="createPaghiperPayment" data-version="0">
                <div class="pull-left">
                  <h1>createPaghiperPayment</h1>
                  <p></p>
                </div>
                <div class="pull-right"></div>
                <div class="clearfix"></div>
                <p></p>
                <p class="marked">Pagamentos em **Pix** ou **Boletos** com a **PagHiper**</p>
                <p></p>
                <br />
                <pre class="prettyprint language-html prettyprinted" data-type="post"><code><span class="pln">/paghiper</span></code></pre>
                <p>
                <h3>Usage and SDK Samples</h3>
                </p>
                <ul class="nav nav-tabs nav-tabs-examples">
                  <li class="active"><a href="#examples-PagHiper-createPaghiperPayment-0-curl">Curl</a></li>
                  <li class=""><a href="#examples-PagHiper-createPaghiperPayment-0-java">Java</a></li>
                  <li class=""><a href="#examples-PagHiper-createPaghiperPayment-0-android">Android</a></li>
                  <!--<li class=""><a href="#examples-PagHiper-createPaghiperPayment-0-groovy">Groovy</a></li>-->
                  <li class=""><a href="#examples-PagHiper-createPaghiperPayment-0-objc">Obj-C</a></li>
                  <li class=""><a href="#examples-PagHiper-createPaghiperPayment-0-javascript">JavaScript</a></li>
                  <!--<li class=""><a href="#examples-PagHiper-createPaghiperPayment-0-angular">Angular</a></li>-->
                  <li class=""><a href="#examples-PagHiper-createPaghiperPayment-0-csharp">C#</a></li>
                  <li class=""><a href="#examples-PagHiper-createPaghiperPayment-0-php">PHP</a></li>
                  <li class=""><a href="#examples-PagHiper-createPaghiperPayment-0-perl">Perl</a></li>
                  <li class=""><a href="#examples-PagHiper-createPaghiperPayment-0-python">Python</a></li>
                </ul>

                <div class="tab-content">
                  <div class="tab-pane active" id="examples-PagHiper-createPaghiperPayment-0-curl">
                    <pre class="prettyprint"><code class="language-bsh">curl -X POST "https://virtserver.swaggerhub.com/LUCASTMB2016/picpago/1.0.0/paghiper"</code></pre>
                  </div>
                  <div class="tab-pane" id="examples-PagHiper-createPaghiperPayment-0-java">
                    <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.PagHiperApi;

import java.io.File;
import java.util.*;

public class PagHiperApiExample {

    public static void main(String[] args) {
        
        PagHiperApi apiInstance = new PagHiperApi();
        array[paghiperInput] corpo = ; // array[paghiperInput] | Descrição do corpo da solicitação
        try {
            array[paghiperResponse] result = apiInstance.createPaghiperPayment(corpo);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling PagHiperApi#createPaghiperPayment");
            e.printStackTrace();
        }
    }
}</code></pre>
                  ...
                  <div class="tab-pane" id="examples-PagHiper-createPaghiperPayment-0-android">
                    <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.PagHiperApi;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            e.printStackTrace();
                  ...
                  <!--
  <div class="tab-pane" id="examples-PagHiper-createPaghiperPayment-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                  <div class="tab-pane" id="examples-PagHiper-createPaghiperPayment-0-objc">
                    <pre class="prettyprint"><code class="language-cpp">array[paghiperInput] *corpo = ; // Descrição do corpo da solicitação

PagHiperApi *apiInstance = [[PagHiperApi alloc] init];

[apiInstance createPaghiperPaymentWith:corpo
              completionHandler: ^(array[paghiperResponse] output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            }
                            if (error) {
                  ...
                  <div class="tab-pane" id="examples-PagHiper-createPaghiperPayment-0-javascript">
                    <pre class="prettyprint"><code class="language-js">var PicPago = require('pic_pago');

var api = new PicPago.PagHiperApi()

var corpo = ; // {array[paghiperInput]} Descrição do corpo da solicitação
...
api.createPaghiperPayment(corpo, callback);
</code></pre>
                  </div>

                  <!--<div class="tab-pane" id="examples-PagHiper-createPaghiperPayment-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                  <div class="tab-pane" id="examples-PagHiper-createPaghiperPayment-0-csharp">
                    <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class createPaghiperPaymentExample
    {
        public void main()
        {
            
            var apiInstance = new PagHiperApi();
            var corpo = new array[paghiperInput](); // array[paghiperInput] | Descrição do corpo da solicitação
            ...
            {
                Debug.Print("Exception when calling PagHiperApi.createPaghiperPayment: " + e.Message );
            }
        }
    }
}
                  ...
                  <div class="tab-pane" id="examples-PagHiper-createPaghiperPayment-0-php">
                    <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');

$api_instance = new Swagger\Client\Api\PagHiperApi();
$corpo = ; // array[paghiperInput] | Descrição do corpo da solicitação

try {
    $result = $api_instance->createPaghiperPayment($corpo);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling PagHiperApi->createPaghiperPayment: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                  </div>

                  <div class="tab-pane" id="examples-PagHiper-createPaghiperPayment-0-perl">
                    <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::PagHiperApi;

my $api_instance = WWW::SwaggerClient::PagHiperApi->new();
my $corpo = [WWW::SwaggerClient::Object::array[paghiperInput]->new()]; # array[paghiperInput] | Descrição do corpo da solicitação

eval { 
    my $result = $api_instance->createPaghiperPayment(corpo => $corpo);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling PagHiperApi->createPaghiperPayment: $@\n";
}</code></pre>
                  </div>

                  <div class="tab-pane" id="examples-PagHiper-createPaghiperPayment-0-python">
                    <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
# create an instance of the API class
api_instance = swagger_client.PagHiperApi()
corpo =  # array[paghiperInput] | Descrição do corpo da solicitação

try: 
    api_response = api_instance.create_paghiper_payment(corpo)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling PagHiperApi->createPaghiperPayment: %s\n" % e)</code></pre>
                  </div>
                </div>
                    ...
                    <td>
                      ...
                      <script>
                        $(document).ready(function() {
                          ...
                          var result = $('#d2e199_createPaghiperPayment_corpo');
                          result.empty();
                          result.append(view.render());
                        });
                      </script>
                      <div id="d2e199_createPaghiperPayment_corpo"></div>
                    </td>
                  </tr>
                ...
                <h2>Responses</h2>
                <h3> Status: 201 - retorna informações do pagamentoda Stripe </h3>

                <ul class="nav nav-tabs nav-tabs-examples">
                  <li class="active">
                    <a data-toggle="tab" href="#responses-createPaghiperPayment-201-schema">Schema</a>
                  </li>

                </ul>

                <div class="tab-content" style='margin-bottom: 10px;'>
                  <div class="tab-pane active" id="responses-createPaghiperPayment-201-schema">
                    <div id='responses-createPaghiperPayment-201-schema-201' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                      <script>
                        $(document).ready(function() {
                          var schemaWrapper = {
                            "description": "retorna informações do pagamentoda Stripe",
                            "schema": {
                              "type": "array",
                              "items": {
                                "$ref": "#/definitions/paghiperResponse"
                              }
                            }
                          };
                          var schema = schemaWrapper.schema;
                          ...
                          //console.log(JSON.stringify(schema));
                          var view = new JSONSchemaView(schema, 3);
                          $('#responses-createPaghiperPayment-201-schema-data').val(stringify(schema));
                          var result = $('#responses-createPaghiperPayment-201-schema-201');
                          result.empty();
                          result.append(view.render());
                        });
                      </script>
                    </div>
                    <input id='responses-createPaghiperPayment-201-schema-data' type='hidden' value=''></input>
                  </div>
                </div>
                ...
                <ul class="nav nav-tabs nav-tabs-examples">
                  <li class="active">
                    <a data-toggle="tab" href="#responses-createPaghiperPayment-default-schema">Schema</a>
                  </li>

                </ul>

                <div class="tab-content" style='margin-bottom: 10px;'>
                  <div class="tab-pane active" id="responses-createPaghiperPayment-default-schema">
                    <div id='responses-createPaghiperPayment-default-schema-default' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                      <script>
                        $(document).ready(function() {
                          var schemaWrapper = {
                            "description": "Erro Inesperado",
                          ...
                          //console.log(JSON.stringify(schema));
                          var view = new JSONSchemaView(schema, 3);
                          $('#responses-createPaghiperPayment-default-schema-data').val(stringify(schema));
                          var result = $('#responses-createPaghiperPayment-default-schema-default');
                          result.empty();
                          result.append(view.render());
                        });
                      </script>
                    </div>
                    <input id='responses-createPaghiperPayment-default-schema-data' type='hidden' value=''></input>
                  </div>
                </div>
          ...
          <section id="api-PagarMe">
            <h1>PagarMe</h1>
            <div id="api-PagarMe-createPagarmePayment">
              <article id="api-PagarMe-createPagarmePayment-0" data-group="User" data-name="createPagarmePayment" data-version="0">
                <div class="pull-left">
                  <h1>createPagarmePayment</h1>
                  <p></p>
                </div>
                <div class="pull-right"></div>
                <div class="clearfix"></div>
                <p></p>
                <p class="marked">Pagamentos em **Pix** ou **Boletos** ou **Cartão de Crédito** com a **PagHiper**</p>
                <p></p>
                <br />
                <pre class="prettyprint language-html prettyprinted" data-type="post"><code><span class="pln">/pagarme</span></code></pre>
                <p>
                <h3>Usage and SDK Samples</h3>
                </p>
                <ul class="nav nav-tabs nav-tabs-examples">
                  <li class="active"><a href="#examples-PagarMe-createPagarmePayment-0-curl">Curl</a></li>
                  <li class=""><a href="#examples-PagarMe-createPagarmePayment-0-java">Java</a></li>
                  <li class=""><a href="#examples-PagarMe-createPagarmePayment-0-android">Android</a></li>
                  <!--<li class=""><a href="#examples-PagarMe-createPagarmePayment-0-groovy">Groovy</a></li>-->
                  <li class=""><a href="#examples-PagarMe-createPagarmePayment-0-objc">Obj-C</a></li>
                  <li class=""><a href="#examples-PagarMe-createPagarmePayment-0-javascript">JavaScript</a></li>
                  <!--<li class=""><a href="#examples-PagarMe-createPagarmePayment-0-angular">Angular</a></li>-->
                  <li class=""><a href="#examples-PagarMe-createPagarmePayment-0-csharp">C#</a></li>
                  <li class=""><a href="#examples-PagarMe-createPagarmePayment-0-php">PHP</a></li>
                  <li class=""><a href="#examples-PagarMe-createPagarmePayment-0-perl">Perl</a></li>
                  <li class=""><a href="#examples-PagarMe-createPagarmePayment-0-python">Python</a></li>
                </ul>

                <div class="tab-content">
                  <div class="tab-pane active" id="examples-PagarMe-createPagarmePayment-0-curl">
                    <pre class="prettyprint"><code class="language-bsh">curl -X POST "https://picpago.com.br/index.php/api/"</code></pre>
                  </div>
                  <div class="tab-pane" id="examples-PagarMe-createPagarmePayment-0-java">
                    <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.PagarMeApi;

import java.io.File;
import java.util.*;

public class PagarMeApiExample {

    public static void main(String[] args) {
        
        PagarMeApi apiInstance = new PagarMeApi();
        array[pagarmeInput] corpo = ; // array[pagarmeInput] | Descrição do corpo da solicitação
        try {
            array[pagarmeResponse] result = apiInstance.createPagarmePayment(corpo);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling PagarMeApi#createPagarmePayment");
            e.printStackTrace();
        }
    }
}</code></pre>
                  ...
                  <div class="tab-pane" id="examples-PagarMe-createPagarmePayment-0-android">
                    <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.PagarMeApi;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            e.printStackTrace();
                  ...
                  <!--
  <div class="tab-pane" id="examples-PagarMe-createPagarmePayment-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                  <div class="tab-pane" id="examples-PagarMe-createPagarmePayment-0-objc">
                    <pre class="prettyprint"><code class="language-cpp">array[pagarmeInput] *corpo = ; // Descrição do corpo da solicitação

PagarMeApi *apiInstance = [[PagarMeApi alloc] init];

[apiInstance createPagarmePaymentWith:corpo
              completionHandler: ^(array[pagarmeResponse] output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            }
                            if (error) {
                  ...
                  <div class="tab-pane" id="examples-PagarMe-createPagarmePayment-0-javascript">
                    <pre class="prettyprint"><code class="language-js">var PicPago = require('pic_pago');

var api = new PicPago.PagarMeApi()

var corpo = ; // {array[pagarmeInput]} Descrição do corpo da solicitação
...
api.createPagarmePayment(corpo, callback);
</code></pre>
                  </div>

                  <!--<div class="tab-pane" id="examples-PagarMe-createPagarmePayment-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                  <div class="tab-pane" id="examples-PagarMe-createPagarmePayment-0-csharp">
                    <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class createPagarmePaymentExample
    {
        public void main()
        {
            
            var apiInstance = new PagarMeApi();
            var corpo = new array[pagarmeInput](); // array[pagarmeInput] | Descrição do corpo da solicitação
            ...
            {
                Debug.Print("Exception when calling PagarMeApi.createPagarmePayment: " + e.Message );
            }
        }
    }
}
                  ...
                  <div class="tab-pane" id="examples-PagarMe-createPagarmePayment-0-php">
                    <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');

$api_instance = new Swagger\Client\Api\PagarMeApi();
$corpo = ; // array[pagarmeInput] | Descrição do corpo da solicitação

try {
    $result = $api_instance->createPagarmePayment($corpo);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling PagarMeApi->createPagarmePayment: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                  </div>

                  <div class="tab-pane" id="examples-PagarMe-createPagarmePayment-0-perl">
                    <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::PagarMeApi;

my $api_instance = WWW::SwaggerClient::PagarMeApi->new();
my $corpo = [WWW::SwaggerClient::Object::array[pagarmeInput]->new()]; # array[pagarmeInput] | Descrição do corpo da solicitação

eval { 
    my $result = $api_instance->createPagarmePayment(corpo => $corpo);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling PagarMeApi->createPagarmePayment: $@\n";
}</code></pre>
                  </div>

                  <div class="tab-pane" id="examples-PagarMe-createPagarmePayment-0-python">
                    <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
# create an instance of the API class
api_instance = swagger_client.PagarMeApi()
corpo =  # array[pagarmeInput] | Descrição do corpo da solicitação

try: 
    api_response = api_instance.create_pagarme_payment(corpo)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling PagarMeApi->createPagarmePayment: %s\n" % e)</code></pre>
                  </div>
                </div>
                    ...
                    <td>
                      ...
                      <script>
                        $(document).ready(function() {
                          ...
                          var result = $('#d2e199_createPagarmePayment_corpo');
                          result.empty();
                          result.append(view.render());
                        });
                      </script>
                      <div id="d2e199_createPagarmePayment_corpo"></div>
                    </td>
                  </tr>
                ...
                <ul class="nav nav-tabs nav-tabs-examples">
                  <li class="active">
                    <a data-toggle="tab" href="#responses-createPagarmePayment-201-schema">Schema</a>
                  </li>

                </ul>

                <div class="tab-content" style='margin-bottom: 10px;'>
                  <div class="tab-pane active" id="responses-createPagarmePayment-201-schema">
                    <div id='responses-createPagarmePayment-201-schema-201' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                      <script>
                        $(document).ready(function() {
                          var schemaWrapper = {
                            "description": "retorna informações do pagamentoda Stripe",
                            "schema": {
                              "type": "array",
                              "items": {
                                "$ref": "#/definitions/pagarmeResponse"
                              }
                            }
                          };
                          var schema = schemaWrapper.schema;
                          ...
                          //console.log(JSON.stringify(schema));
                          var view = new JSONSchemaView(schema, 3);
                          $('#responses-createPagarmePayment-201-schema-data').val(stringify(schema));
                          var result = $('#responses-createPagarmePayment-201-schema-201');
                          result.empty();
                          result.append(view.render());
                        });
                      </script>
                    </div>
                    <input id='responses-createPagarmePayment-201-schema-data' type='hidden' value=''></input>
                  </div>
                </div>
                ...
                <ul class="nav nav-tabs nav-tabs-examples">
                  <li class="active">
                    <a data-toggle="tab" href="#responses-createPagarmePayment-default-schema">Schema</a>
                  </li>

                </ul>

                <div class="tab-content" style='margin-bottom: 10px;'>
                  <div class="tab-pane active" id="responses-createPagarmePayment-default-schema">
                    <div id='responses-createPagarmePayment-default-schema-default' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                      <script>
                        $(document).ready(function() {
                          var schemaWrapper = {
                            "description": "Erro Inesperado",
                          ...
                          //console.log(JSON.stringify(schema));
                          var view = new JSONSchemaView(schema, 3);
                          $('#responses-createPagarmePayment-default-schema-data').val(stringify(schema));
                          var result = $('#responses-createPagarmePayment-default-schema-default');
                          result.empty();
                          result.append(view.render());
                        });
                      </script>
                    </div>
                    <input id='responses-createPagarmePayment-default-schema-data' type='hidden' value=''></input>
                  </div>
                </div>
          ...
          <section id="api-Stripe">
            <h1>Stripe</h1>
            <div id="api-Stripe-createStripePayment">
              <article id="api-Stripe-createStripePayment-0" data-group="User" data-name="createStripePayment" data-version="0">
                <div class="pull-left">
                  <h1>createStripePayment</h1>
                  <p></p>
                </div>
                <div class="pull-right"></div>
                <div class="clearfix"></div>
                <p></p>
                <p class="marked">Criar Pagamentos com a **Stripe** é obrigatório usar o checkout dela. **Importante** Exemplo &lt; script src&#x3D;&quot;https://checkout.stripe.com/checkout.js&quot; class&#x3D;&quot;stripe-button&quot; data-key&#x3D;&quot;&quot; data-amount&#x3D;&quot;100&quot; data-name&#x3D;&quot;Exemplo de pagamento&quot; data-description&#x3D;&quot;Exemplo de item&quot; data-image&#x3D;&quot;https://stripe.com/img/documentation/checkout/marketplace.png&quot; data-locale&#x3D;&quot;auto&quot;&gt; &lt;/ script&gt;</p>
                <p></p>
                <br />
                <pre class="prettyprint language-html prettyprinted" data-type="post"><code><span class="pln">/stripe</span></code></pre>
                <p>
                <h3>Usage and SDK Samples</h3>
                </p>
                <ul class="nav nav-tabs nav-tabs-examples">
                  <li class="active"><a href="#examples-Stripe-createStripePayment-0-curl">Curl</a></li>
                  <li class=""><a href="#examples-Stripe-createStripePayment-0-java">Java</a></li>
                  <li class=""><a href="#examples-Stripe-createStripePayment-0-android">Android</a></li>
                  <!--<li class=""><a href="#examples-Stripe-createStripePayment-0-groovy">Groovy</a></li>-->
                  <li class=""><a href="#examples-Stripe-createStripePayment-0-objc">Obj-C</a></li>
                  <li class=""><a href="#examples-Stripe-createStripePayment-0-javascript">JavaScript</a></li>
                  <!--<li class=""><a href="#examples-Stripe-createStripePayment-0-angular">Angular</a></li>-->
                  <li class=""><a href="#examples-Stripe-createStripePayment-0-csharp">C#</a></li>
                  <li class=""><a href="#examples-Stripe-createStripePayment-0-php">PHP</a></li>
                  <li class=""><a href="#examples-Stripe-createStripePayment-0-perl">Perl</a></li>
                  <li class=""><a href="#examples-Stripe-createStripePayment-0-python">Python</a></li>
                </ul>

                <div class="tab-content">
                  <div class="tab-pane active" id="examples-Stripe-createStripePayment-0-curl">
                    <pre class="prettyprint"><code class="language-bsh">curl -X POST "https://virtserver.swaggerhub.com/LUCASTMB2016/picpago/1.0.0/stripe"</code></pre>
                  </div>
                  <div class="tab-pane" id="examples-Stripe-createStripePayment-0-java">
                    <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
...
public class StripeApiExample {
    ...
    public static void main(String[] args) {
        ...
        array[StripeInput] corpo = ; // array[StripeInput] | Descrição do corpo da solicitação
        try {
            array[StripeResponse] result = apiInstance.createStripePayment(corpo);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling StripeApi#createStripePayment");
            e.printStackTrace();
        }
    }
}</code></pre>
                  ...
                  <div class="tab-pane" id="examples-Stripe-createStripePayment-0-android">
                    <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.StripeApi;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            e.printStackTrace();
                  ...
                  <!--
  <div class="tab-pane" id="examples-Stripe-createStripePayment-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                  <div class="tab-pane" id="examples-Stripe-createStripePayment-0-objc">
                    <pre class="prettyprint"><code class="language-cpp">array[StripeInput] *corpo = ; // Descrição do corpo da solicitação

StripeApi *apiInstance = [[StripeApi alloc] init];

[apiInstance createStripePaymentWith:corpo
              completionHandler: ^(array[StripeResponse] output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            }
                            if (error) {
                  ...
                  <div class="tab-pane" id="examples-Stripe-createStripePayment-0-javascript">
                    <pre class="prettyprint"><code class="language-js">var PicPago = require('pic_pago');

var api = new PicPago.StripeApi()

var corpo = ; // {array[StripeInput]} Descrição do corpo da solicitação
...
api.createStripePayment(corpo, callback);
</code></pre>
                  </div>

                  <!--<div class="tab-pane" id="examples-Stripe-createStripePayment-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                  <div class="tab-pane" id="examples-Stripe-createStripePayment-0-csharp">
                    <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class createStripePaymentExample
    {
        public void main()
        {
            
            var apiInstance = new StripeApi();
            var corpo = new array[StripeInput](); // array[StripeInput] | Descrição do corpo da solicitação
            ...
            {
                Debug.Print("Exception when calling StripeApi.createStripePayment: " + e.Message );
            }
        }
    }
}
                  ...
                  <div class="tab-pane" id="examples-Stripe-createStripePayment-0-php">
                    <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');

$api_instance = new Swagger\Client\Api\StripeApi();
$corpo = ; // array[StripeInput] | Descrição do corpo da solicitação

try {
    $result = $api_instance->createStripePayment($corpo);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling StripeApi->createStripePayment: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                  </div>

                  <div class="tab-pane" id="examples-Stripe-createStripePayment-0-perl">
                    <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::StripeApi;

my $api_instance = WWW::SwaggerClient::StripeApi->new();
my $corpo = [WWW::SwaggerClient::Object::array[StripeInput]->new()]; # array[StripeInput] | Descrição do corpo da solicitação

eval { 
    my $result = $api_instance->createStripePayment(corpo => $corpo);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling StripeApi->createStripePayment: $@\n";
}</code></pre>
                  </div>

                  <div class="tab-pane" id="examples-Stripe-createStripePayment-0-python">
                    <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    api_response = api_instance.create_stripe_payment(corpo)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling StripeApi->createStripePayment: %s\n" % e)</code></pre>
                  </div>
                </div>
                    ...
                    <td>
                      ...
                      <script>
                        $(document).ready(function() {
                          ...
                          var result = $('#d2e199_createStripePayment_corpo');
                          result.empty();
                          result.append(view.render());
                        });
                      </script>
                      <div id="d2e199_createStripePayment_corpo"></div>
                    </td>
                  </tr>
                ...
                <ul class="nav nav-tabs nav-tabs-examples">
                  <li class="active">
                    <a data-toggle="tab" href="#responses-createStripePayment-201-schema">Schema</a>
                  </li>

                </ul>

                <div class="tab-content" style='margin-bottom: 10px;'>
                  <div class="tab-pane active" id="responses-createStripePayment-201-schema">
                    <div id='responses-createStripePayment-201-schema-201' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                      <script>
                        $(document).ready(function() {
                          var schemaWrapper = {
                            "description": "retorna informações do pagamentoda Stripe",
                            "schema": {
                              "type": "array",
                              "items": {
                                "$ref": "#/definitions/StripeResponse"
                              }
                            }
                          };
                          var schema = schemaWrapper.schema;
                          ...
                          //console.log(JSON.stringify(schema));
                          var view = new JSONSchemaView(schema, 3);
                          $('#responses-createStripePayment-201-schema-data').val(stringify(schema));
                          var result = $('#responses-createStripePayment-201-schema-201');
                          result.empty();
                          result.append(view.render());
                        });
                      </script>
                    </div>
                    <input id='responses-createStripePayment-201-schema-data' type='hidden' value=''></input>
                  </div>
                </div>
                ...
                <ul class="nav nav-tabs nav-tabs-examples">
                  <li class="active">
                    <a data-toggle="tab" href="#responses-createStripePayment-default-schema">Schema</a>
                  </li>

                </ul>

                <div class="tab-content" style='margin-bottom: 10px;'>
                  <div class="tab-pane active" id="responses-createStripePayment-default-schema">
                    <div id='responses-createStripePayment-default-schema-default' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                      <script>
                        $(document).ready(function() {
                          var schemaWrapper = {
                            "description": "Erro Inesperado",
                          ...
                          //console.log(JSON.stringify(schema));
                          var view = new JSONSchemaView(schema, 3);
                          $('#responses-createStripePayment-default-schema-data').val(stringify(schema));
                          var result = $('#responses-createStripePayment-default-schema-default');
                          result.empty();
                          result.append(view.render());
                        });
                      </script>
                    </div>
                    <input id='responses-createStripePayment-default-schema-data' type='hidden' value=''></input>
                  </div>
                </div>
            ...
            <hr>
            <div id="api-Stripe-stripe">
              <article id="api-Stripe-stripe-0" data-group="User" data-name="stripe" data-version="0">
                <div class="pull-left">
                  <h1>stripe</h1>
                  <p></p>
                </div>
                ...
                <p></p>
                <br />
                <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/stripe</span></code></pre>
                <p>
                <h3>Usage and SDK Samples</h3>
                </p>
                <ul class="nav nav-tabs nav-tabs-examples">
                  <li class="active"><a href="#examples-Stripe-stripe-0-curl">Curl</a></li>
                  <li class=""><a href="#examples-Stripe-stripe-0-java">Java</a></li>
                  <li class=""><a href="#examples-Stripe-stripe-0-android">Android</a></li>
                  <!--<li class=""><a href="#examples-Stripe-stripe-0-groovy">Groovy</a></li>-->
                  <li class=""><a href="#examples-Stripe-stripe-0-objc">Obj-C</a></li>
                  <li class=""><a href="#examples-Stripe-stripe-0-javascript">JavaScript</a></li>
                  <!--<li class=""><a href="#examples-Stripe-stripe-0-angular">Angular</a></li>-->
                  <li class=""><a href="#examples-Stripe-stripe-0-csharp">C#</a></li>
                  <li class=""><a href="#examples-Stripe-stripe-0-php">PHP</a></li>
                  <li class=""><a href="#examples-Stripe-stripe-0-perl">Perl</a></li>
                  <li class=""><a href="#examples-Stripe-stripe-0-python">Python</a></li>
                </ul>

                <div class="tab-content">
                  <div class="tab-pane active" id="examples-Stripe-stripe-0-curl">
                    <pre class="prettyprint"><code class="language-bsh">curl -X GET "https://virtserver.swaggerhub.com/LUCASTMB2016/picpago/1.0.0/stripe"</code></pre>
                  </div>
                  <div class="tab-pane" id="examples-Stripe-stripe-0-java">
                    <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.StripeApi;
...
public class StripeApiExample {
    ...
    public static void main(String[] args) {
        ...
        StripeApi apiInstance = new StripeApi();
        try {
            array[Stripe] result = apiInstance.stripe();
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling StripeApi#stripe");
            e.printStackTrace();
        }
    }
}</code></pre>
                  ...
                  <div class="tab-pane" id="examples-Stripe-stripe-0-android">
                    <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.StripeApi;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            e.printStackTrace();
                  ...
                  <!--
  <div class="tab-pane" id="examples-Stripe-stripe-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                  <div class="tab-pane" id="examples-Stripe-stripe-0-objc">
                    <pre class="prettyprint"><code class="language-cpp">
StripeApi *apiInstance = [[StripeApi alloc] init];

[apiInstance stripeWithCompletionHandler: 
              ^(array[Stripe] output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            }
                            if (error) {
                  ...
                  <div class="tab-pane" id="examples-Stripe-stripe-0-javascript">
                    <pre class="prettyprint"><code class="language-js">var PicPago = require('pic_pago');
...
api.stripe(callback);
                  ...
                  <!--<div class="tab-pane" id="examples-Stripe-stripe-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                  <div class="tab-pane" id="examples-Stripe-stripe-0-csharp">
                    <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class stripeExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling StripeApi.stripe: " + e.Message );
            }
        }
    }
}
                  ...
                  <div class="tab-pane" id="examples-Stripe-stripe-0-php">
                    <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
try {
    $result = $api_instance->stripe();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling StripeApi->stripe: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                  </div>

                  <div class="tab-pane" id="examples-Stripe-stripe-0-perl">
                    <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::StripeApi;
...
eval { 
    my $result = $api_instance->stripe();
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling StripeApi->stripe: $@\n";
}</code></pre>
                  </div>

                  <div class="tab-pane" id="examples-Stripe-stripe-0-python">
                    <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    api_response = api_instance.stripe()
    pprint(api_response)
except ApiException as e:
    print("Exception when calling StripeApi->stripe: %s\n" % e)</code></pre>
                  </div>
                </div>
                ...
                <ul class="nav nav-tabs nav-tabs-examples">
                  <li class="active">
                    <a data-toggle="tab" href="#responses-stripe-200-schema">Schema</a>
                  </li>

                </ul>

                <div class="tab-content" style='margin-bottom: 10px;'>
                  <div class="tab-pane active" id="responses-stripe-200-schema">
                    <div id='responses-stripe-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                      <script>
                        $(document).ready(function() {
                          var schemaWrapper = {
                            "description": "retorna informações do pagamento Mercado Pago",
                          ...
                          //console.log(JSON.stringify(schema));
                          var view = new JSONSchemaView(schema, 3);
                          $('#responses-stripe-200-schema-data').val(stringify(schema));
                          var result = $('#responses-stripe-200-schema-200');
                          result.empty();
                          result.append(view.render());
                        });
                      </script>
                    </div>
                    <input id='responses-stripe-200-schema-data' type='hidden' value=''></input>
                  </div>
                </div>
                ...
                <ul class="nav nav-tabs nav-tabs-examples">
                  <li class="active">
                    <a data-toggle="tab" href="#responses-stripe-default-schema">Schema</a>
                  </li>

                </ul>

                <div class="tab-content" style='margin-bottom: 10px;'>
                  <div class="tab-pane active" id="responses-stripe-default-schema">
                    <div id='responses-stripe-default-schema-default' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                      <script>
                        $(document).ready(function() {
                          var schemaWrapper = {
                            "description": "Erro Inesperado",
                          ...
                          //console.log(JSON.stringify(schema));
                          var view = new JSONSchemaView(schema, 3);
                          $('#responses-stripe-default-schema-data').val(stringify(schema));
                          var result = $('#responses-stripe-default-schema-default');
                          result.empty();
                          result.append(view.render());
                        });
                      </script>
                    </div>
                    <input id='responses-stripe-default-schema-data' type='hidden' value=''></input>
                  </div>
                </div>
        ...
        <div id="footer">
          <div id="api-_footer">
            ...
            <div class="app-desc">Information URL: <a href="https://picpago.com.br/">https://picpago.com.br/</a></div>
            <div class="app-desc">Contact Info: <a href="info@picpago.com.br">info@picpago.com.br</a></div>
            </p>
