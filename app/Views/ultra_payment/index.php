...
<body>
    ...
    <div class="logo-plans">
        ...
        <h2>Agora falta pouco para concluir seu pagamento, e se tornar um <span>Revendendor Ultra</span>, escolha seu método de pagamento e conclua sua assinatura agora!</h2>
    </div>
     ...
     <select id="selecaoConteudo" onchange="alternarConteudo()">
        ...
        <div id="conteudo1" >
         ...
         <div class="card-header text-center form-head">
                <h2 class="form-signin-heading">Plano Revendedor Ultra</h2>
    ...
    <?php echo form_open('mercadopago_payment/processPayment', ['id' => 'pix-form', "class" => "general-form"]); ?>
     <div class="card-body card-pix p30 rounded-bottom">
            <div>Valor: <?= $admin['ultra_value']; ?> R$</div>
            <div>Descrição: Plano Revendedor Ultra</div>
            <div>Método de Pagamento: Pix</div>
            <div>Email: <?php echo $email; ?></div>
            <input type="hidden" id="dealer" name="dealer" value="2">
