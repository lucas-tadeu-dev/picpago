...
<body>
     ...
     <select id="selecaoConteudo" onchange="alternarConteudo()">
        ...
        <div id="conteudo1" >
         ...
         <div class="card-header text-center form-head">
             ...
             $amount = $package['coins_quantity']*$package_value; 
             ?>
    <?php echo form_open('package_payment/mercadoPagoPix', ['id' => 'pix-form', "class" => "general-form"]); ?>
     <div class="card-body card-pix p30 rounded-bottom">
           <div id="value">Valor: <?php echo $amount; ?> R$</div> 
            ...
            <input type="hidden" name="coins_quantity" value="<?php echo $package['coins_quantity']; ?>">
    ...
    <?php echo form_open('package_payment/mercadoPagoCreditCard', ['id' => 'pay', "class" => "general-form"]); ?>
