...
<div id="page-content" class="clearfix">
    ...
    <ul id="team-member-view-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs scrollable-tabs rounded-0" role="tablist">
        ...
        <?php } ?>
         ...
         <?php if ($show_general_info) { ?>
            <li><a  role="presentation" data-bs-toggle="tab" href="<?php echo_uri("team_members/integration/" . $user_info->id); ?>" data-bs-target="#tab-integration"> <?php echo 'Integração'; ?></a></li>
        <?php } ?>
    ...
    <div class="tab-content">
        ...
        <div role="tabpanel" class="tab-pane fade" id="tab-integration"></div>
    ...
    $(document).ready(function () {
        ...
        setTimeout(function () {
            ...
            if (tab === "general") {
                ...
                $("[data-bs-target='#tab-integration']").trigger("click");
            }else if (tab === "account") {
