...
<body>
    ...
    <div class="logo-plans">
        <!--<img src="https://picpago.com.br/files/system/_file63f0c3d0aea6d-site-logo.png" alt="logo" class="logo">-->
            <a class="logo-white" href="https://picpago.com.br/"><span>PIC</span>PAGO</a>
        <h2>Agora falta pouco para concluir seu pagamento, e se tornar um <span>Revendendor Master</span>, escolha seu método de pagamento e conclua sua assinatura agora!</h2>
    </div>
     ...
     <select id="selecaoConteudo" onchange="alternarConteudo()">
        ...
        <div id="conteudo1" >
         ...
         <div class="card-header text-center form-head">
                <h2 class="form-signin-heading">Plano Revendedor Master</h2>
                <p>Pague no Pix e ative a sua assinatura mensal!</p>
        </div>
    <?php echo form_open('mercadopago_payment/processPayment', ['id' => 'pix-form', "class" => "general-form"]); ?>
    <div class="select-plans select-month">
          <select name="month_quantity" id="month_quantity">
            <option value="one">1 mês</option>
            <option value="six">6 meses</option>
            <option value="twelve">12 meses</option>
 </select>
</div>    
     <div class="card-body card-pix p30 rounded-bottom">
           <div id="value">Valor: <?= $admin['master_value']; ?> R$</div>
         <div id="discount">Desconto de R$ 0</div>
    ...
    <?php echo form_open('mercadopago_payment/creditCard', ['id' => 'pay', "class" => "general-form"]); ?>
    <div class="select-plans select-month">
          <select name="month_quantity" id="month_quantity">
            <option value="one">1 mês</option>
            <option value="six">6 meses</option>
     ...
     <?php echo form_close(); ?>
      <script>
        ...
        Mercadopago.setPublishableKey("APP_USR-e54a64cc-fb80-4b75-8dc6-650fb776820a");
...
<script>
var select = document.getElementById('month_quantity');
var valueElement = document.getElementById('value');
var discountElement = document.getElementById('discount');

select.addEventListener('change', function() {
    var masterValue = <?= $admin['master_value']; ?>;
    var period = 1; // Default para 1 mês
    var discount = 0; // Sem desconto

    if (this.value === 'six') {
        period = 6;
        discount = <?= $admin['six_months_descount']; ?>;
    } else if (this.value === 'twelve') {
        period = 12;
        discount = <?= $admin['one_year_descount']; ?>;
    }

    var finalValue = masterValue * period * (1 - (discount / 100));
    var discountValue = masterValue * period - finalValue;

    valueElement.innerHTML = "Valor: " + finalValue + " R$";
    discountElement.innerHTML = "Desconto de R$ " + discountValue;
});
</script>
