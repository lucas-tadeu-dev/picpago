...
class MetaDataReader
{
    ...
    {
        AnnotationRegistry::loadAnnotationClass(__DIR__ . '/Annotation/RestMethod.php');
        AnnotationRegistry::loadAnnotationClass(__DIR__ . '/Annotation/RequestParam.php');
        AnnotationRegistry::loadAnnotationClass(__DIR__ . '/Annotation/Attribute.php');
        AnnotationRegistry::loadAnnotationClass(__DIR__ . '/Annotation/DenyDynamicAttribute.php');
