...
class Master_signup extends BaseController
{   
...
protected $Verification_model;
    ...
    function index() {
        ...
        return $this->template->view("master_signup/index", $view_data);
    }
    ...
    function create_account() {
        ...
        if ($user_id) {
            echo json_encode(array("success" => true, 'message' => "Conta Revedendor Master Criada. Agora falta pouco faça Login e finalize o pagamento!" . " " . anchor(get_uri("signin"), app_lang('signin'), array("class" => "text-white text-off"))));
