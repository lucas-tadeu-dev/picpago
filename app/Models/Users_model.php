...
class Users_model extends Crud_model {
    ...
    function get_details($options = array()) {
        ...
        if ($last_name) {
         ...
         // Adding a new condition for 'created_by'
        if ($created_by) {
            $where .= " AND $users_table.created_by=$created_by";
        }
    ...
    function get_access_info($user_id = 0) {
        ...
        $sql = "SELECT $users_table.id, $users_table.user_type, $users_table.is_admin, $users_table.role_id, $users_table.email,
            $users_table.first_name, $users_table.last_name, $users_table.created_by, $users_table.image, $users_table.message_checked_at, $users_table.notification_checked_at, $users_table.client_id, $users_table.enable_web_notification,
    ...
    public function getUsersCreatedBy($userId)
    {
